...
public class autocloseredShooter extends LinearOpMode {
    ...
    private final Pose startPose   = new Pose(  120, 120, Math.toRadians( 45)); // <-- CHANGE THIS
    private final Pose shootPose   = new Pose(  95, 95, Math.toRadians( 45)); // <-- CHANGE THIS (aimed at far target)
    private final Pose pickupPose1 = new Pose(  95, 72, Math.toRadians(90)); // <-- CHANGE THIS (first pickup)
