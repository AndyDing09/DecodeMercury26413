...
public class Blue_Close_18_Partner extends LinearOpMode {
    ...
    private final Pose PickFromClearPose_INITIAL = new Pose(5.6,  58.25, Math.toRadians(115));
    private final Pose PickFromClearPose_FUTURE  = new Pose(5,    58.6,  Math.toRadians(122.15));
