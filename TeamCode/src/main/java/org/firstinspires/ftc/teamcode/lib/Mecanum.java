...
// */
//public class Mecanum extends Chassis {
//    public MecanumConstant constants;
...
//     */
//    public Mecanum(HardwareMap hardwareMap, MecanumConstant mecanumConstants) {
...
//
//        frontLeftDrive = hardwareMap.get(DcMotorEx.class, mecanumConstants.frontLeftDrive);
//        backLeftDrive = hardwareMap.get(DcMotorEx.class, mecanumConstants.backLeftDrive );
//        frontRightDrive = hardwareMap.get(DcMotorEx.class, mecanumConstants.backRightDrive );
//        backRightDrive= hardwareMap.get(DcMotorEx.class, mecanumConstants.frontRightDrive );
//
//        motors = Arrays.asList(frontLeftDrive, backLeftDrive, frontRightDrive, backRightDrive);
//
...
//        frontLeftDrive.setDirection(constants.frontLeftDriveMotorDirection);
//        backLeftDrive.setDirection(constants.backLeftDriveMotorDirection);
//        frontRightDrive.setDirection(constants.frontRightDriveMotorDirection);
//        backRightDrive.setDirection(constants.backRightDriveMotorDirection);
