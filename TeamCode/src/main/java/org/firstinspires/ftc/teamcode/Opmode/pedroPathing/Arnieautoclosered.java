...
//    private DcMotorEx shooterLeft, shooterLeft1;
...
//
//        shooterLeft  = hardwareMap.get(DcMotorEx.class, "Shooter");
//        shooterLeft1 = hardwareMap.get(DcMotorEx.class, "Shooter1");
//
...
//
//        shooterLeft1.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
//        shooterLeft1.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.FLOAT);
//
...
//        shooterLeft1.setPIDFCoefficients(DcMotor.RunMode.RUN_USING_ENCODER, pidf);
//
...
//        shooterLeft1.setVelocity(ticksPerSec);
//    }
//
