...
@Autonomous(name = "RC18Lines", group = "Auto")
public class Red_Close_18_Lines extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        // ── Pickup 2: two separate BezierLine paths ────────────────────────
        // Leg 1: shoot pose → pickupPose2 (intake off, just driving into position)
        ...
        // Leg 2: pickupPose2 → Intake2End (intake turns on at the start of this path)
        ...
        switch (state) {
            ...
            case 3:
                if (actionTimer.getElapsedTimeSeconds() >= SHOOT_TIME) {
                    ...
                    // Leg 1: drive to pickupPose2, intake off
                    middleTransfer.setPower(0);
            ...
            // ── DRIVE TO PICKUP2 START (intake off) ───────────────────────
            case 4:
                if (!follower.isBusy()) {
                    // Arrived at pickupPose2 — turn on intake and sweep to Intake2End
                    middleTransfer.setPower(1.0);
            ...
            // ── SWEEP TO INTAKE2 END (intake on) ──────────────────────────
            case 5:
                if (!follower.isBusy()) {
